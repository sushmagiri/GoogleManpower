...
//        setSupportActionBar(toolbar);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Professsionals(), "Professionals");
        adapter.addFrag(new Skilled(), "Skilled");
        adapter.addFrag(new SemiSkilled(), "SemiSkilled");
        adapter.addFrag(new UnSkilled(), "Unskilled");
