...
public class TabFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String text = "<html><body>"
                ...
                + "\"Google Overseas Pvt. Ltd. would like to extend it's warm welcome to all of the clients,bussiness parties as well as each and every individuals who choose us for their perfcet and successful future destination.\""+"</p>"
